...
# GitHub: https://github.com/SHIMANTO-404-CYBER
# Version: 0.01
#########################################
...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : XAIKO-SHIMANTO                \033[94m│".center(columns+15))
    print("│ \033[95mTool   : UNLIMITED SMS BOMBER          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : SHIMANTO-404-CYBER \033[94m│".center(columns+9))
    print("│ \033[95mCoder  : SHIMANTO.326              \033[37mV4.1 \033[94m│".center(columns+15))
    print("\033[94m└────────────────────────────────────────┘".center(columns+5))
