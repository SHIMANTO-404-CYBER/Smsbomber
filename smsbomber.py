...
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐀𝐔𝐓𝐇𝐎𝐑   ║  ࿇⃝🌹⃢H🌹⃝࿇  \033[38;5;46m║\033[38;5;46mXAIKO-SHIMANTO              ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 ║  ࿇⃝🌹⃢I🌹⃝࿇  \033[38;5;46m║\033[38;5;46mSHIMANTO CHOWDHURY ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 ║  ࿇⃝🌹⃢M🌹⃝࿇  \033[38;5;46m║\033[38;5;46m8801813080982       ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐆𝐈𝐓𝐇𝐔𝐁   ║  ࿇⃝🌹⃢A🌹⃝࿇  \033[38;5;46m║\033[38;5;46SHIMANTO-404-CYBER    ║
\033[38;5;46m║[🔵]\x1b[38;5;196mKING OF  ║  ࿇⃝🌹⃢N🌹⃝࿇  \033[38;5;46m║\033[38;5;46mKINGDOM'S 👑        ║
\033[38;5;46m║[🔵]\x1b[38;5;196mWORKS    ║  ࿇⃝🌹⃢ T🌹⃝࿇ \033[38;5;46m║\033[38;5;46mData & Wifi         ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐅𝐑𝐎𝐌     ║  ࿇⃝🌹⃢ O🌹⃝࿇\033[38;5;46m ║\033[38;5;46m𝐁𝐀𝐍𝐆𝐋𝐀𝐃𝐄𝐒𝐇          ║
...
rp= 'CYBER'
x = 'SHIMANTO'
if 'XAIKO'==user and 'SHIMANTO'==pas:
	Axak(g+"\n\n\t\t      LOGIN SUCCESSFUL FOLLOW MY FACEBOOK ACCOUNT ")
	os.system('xdg-open https://www.facebook.com/profile.php?id=100006377316183')
else:
...
number=input(f"{c}\n[ VICTIM NUMBER ] :{w} +880")
amo=int(input(c+"\n[ AMOUNT ] : "+w))
xak(f"\n\n\t {w}<{r}/{w}> {g}STAY WITH SHIMANTO-404-CYBER ;) {w}<{r}/{w}>\n\n")
...
for i in range(amo):
	...
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥CYBER-SHIMANTO🔥 "+w+tim)
